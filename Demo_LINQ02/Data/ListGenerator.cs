...
namespace Demo_LINQ02.Data
{
    internal class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ...
            {
                new Product02(){ProductID = 1000 , SerialNumber = 123456 , UnitPrice = 10M},
                new Product02(){ProductID = 2000 , SerialNumber = 456987 , UnitPrice = 9M},
                new Product02(){ProductID = 3000 , SerialNumber = 136547 , UnitPrice = 15M},
                new Product02(){ProductID = 4000 , SerialNumber = 658955 , UnitPrice = 1M},
